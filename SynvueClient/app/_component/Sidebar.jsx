...
const Sidebar = () => {
      ...
      >
        <div>
          ...
          <nav className="flex flex-col gap-5 text-gray-800 font-medium">
            ...
            <div
              onClick={()=>{user ? router.push('/CreateInterView') : router.push('/signin')}}
            ...
            <div
              onClick={()=>{user ? router.push('/Billing') : router.push('/signin')}}
              className="flex items-center gap-3 hover:text-indigo-600 transition cursor-pointer"
            >
            ...
            <div
              onClick={()=>{user ? router.push('/services') : router.push('/signin')}}
              className="flex items-center gap-3 hover:text-indigo-600 transition cursor-pointer"
            >
            ...
            <div
            onClick={()=>{user ? router.push('/Contact') : router.push('/signin')}}
              className="flex items-center gap-3 hover:text-indigo-600 transition cursor-pointer"
            >
            ...
            <div
              onClick={()=>{user ? router.push('/Feedback') : router.push('/signin')}}
              className="flex items-center gap-3 hover:text-indigo-600 transition cursor-pointer"
            >
  ...
  <SignUpButton mode="redirect" signUpUrl="/signup">
